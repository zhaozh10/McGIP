...
class MoCo_sup(BaseModel):
    ...
    def __init__(self,
                 ...
                 **kwargs):
        super(MoCo_sup, self).__init__(init_cfg)
        ...
        # uplimit=6080 if queue_len>6080 else queue_len
        uplimit=queue_len
        self.register_buffer('queue_idx', torch.randint(0, uplimit, (queue_len, 1),dtype=torch.long))
        # self.register_buffer('queue_idx', torch.randint(0, 6080, (queue_len, 1), dtype=torch.long))
    ...
    def _create_buffer(self, N, idx_list,all_gt):
        # print("======== idx_list ========")
        # print(idx_list)
    ...
    def forward_train(self, img,idx, gt,**kwargs):
        ...
        # print(f"all_gt {all_gt}")
        labels = self._create_buffer(q.shape[0], idx_list,all_gt)
