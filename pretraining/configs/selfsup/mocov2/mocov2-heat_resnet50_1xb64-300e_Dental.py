...
threshold=0.7
# bash tools/dist_train.sh configs/selfsup/mocov2/mocov2-heat_resnet50_1xb64-300e_Dental.py 1 --work_dir work_dirs/selfsup/mocov2/mocov2-heat_resnet50_1xb64-300e_Dental
model = dict(
    type='MoCo_heat',
    threshold=threshold,
    queue_len=1280,
