...
# bash tools/dist_train.sh configs/selfsup/mocov2/mocov2_resnet50_1xb16-300e_Dental.py 1 --work_dir work_dirs/selfsup/mocov2/mocov2_resnet50_1xb16-300e_Dental
model = dict(
    type='MoCo',
    queue_len=1280,
    feat_dim=256,
